...
<% 
		 ...
		 Connection conn = null; 	    	
  	     ...
  	     try
  	     {
		        ...
		        String sql3 = "update device set device_shuliang_rest = '"+shengyushuliang+"' where number='"+number+"'";
		        
		        statement3 = conn.prepareStatement(sql3);
		        statement3.executeUpdate(sql3);
		        
		       // out.println(shengyushuliang);
		        
		        
				response.sendRedirect("look_shebei_add.jsp");
