...
<% 	     
		 ...
		 Connection conn = null; 	    
   	  	 ...
   	  	 String sql2 = "select * from medicine where number = '" +number+ "'";
  ...
  <head>
	...
	<script>
		...
		function add_borrow(number)
	 	{
	 		var url = "look_yaopin_add.jsp" + "?id=" + number;
    	...
    	<table>
    		<tr>
    			...
    			<% 
    				...
    				{
    			%>
    			<td><input value="<%=rs2.getString("medicine_shuliang_total") %>" readonly /></td>
    			<th scope="col">药品/消耗品剩余数量</th>
    			<td><input value="<%=rs2.getString("medicine_shuliang_rest") %>" readonly /></td>
    			<% 
    				}
    			%>
    		</tr>
