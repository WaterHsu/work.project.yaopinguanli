...
<% 	     
		 ...
		 Connection conn = null; 	    
   	  	 ...
   	  	 String sql2 = "select * from book where number = '" +number+ "'";
  ...
  <head>
	...
	<script>
		...
		function add_borrow(number)
	 	{
	 		var url = "look_tushu_add.jsp" + "?id=" + number;
    	...
    	<table>
    		<tr>
    			...
    			<% 
    				...
    				{
    			%>
    			<td><input value="<%=rs2.getString("book_shuliang_total") %>" readonly /></td>
    			<th scope="col">药品/消耗品剩余数量</th>
    			<td><input value="<%=rs2.getString("book_shuliang_rest") %>" readonly /></td>
    			<% 
    				}
    			%>
    		</tr>
